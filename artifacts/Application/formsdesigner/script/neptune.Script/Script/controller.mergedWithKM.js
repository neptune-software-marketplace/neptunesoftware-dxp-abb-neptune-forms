const controller = {
    ...
    init: function () {
        ...
        // AC: Connector Enhancement // #18 KM
        getConnectorList(); // #18 KM
    ...
    handleContextMenu: function (oEvent, key, item) {
        ...
        switch (key) {
            ...
            case "add":
                ...
                // Ensure item is valid for add (Map Control) // #18 KM
                if (!controller.validateItemForAddCopy(item)) return; // #18 KM
    ...
    clearVisibleCondition: function (element) {
        ...
        // // AC: Conditional Visibility // #18 KM
        // element.visibleValueFrom = 0; // #18 KM
        // element.visibleValueTo = 0; // #18 KM
    },
    ...
    addElement: function (elementData, copy, parentType) {
        let newElement = {
            ...
            enableLabel: true,
            enablePrePopulated: false, // AC: Field Pre Populated // #18 KM
            prePopulatedValue: "", // AC: Field Pre Populated // #18 KM
            prePopulatedFreeValue: "", // AC: Field Pre Populated // #18 KM
            hideElement: false, // AC: Element Visibility in Form // #18 KM
            disabled: false,
        ...
        switch (elementData.type) {
            ...
            case "Table":
                ...
                newElement.expanded = false; // #18 KM
                newElement.expandable = false; // #18 KM
                newElement.option = "P";
                newElement.elements = [];
                newElement.widths = [];
                newElement.rows = 5;
            ...
            case "Numeric":
                ...
                newElement.enableLimits = false; // AC: Numeric Limits // #18 KM
                break;
            ...
            case "SingleChoice":
                ...
                // AC: Single Select Enable Connector // #18 KM
                newElement.enableConnector = false; // #18 KM
                break;

            case "SingleSelect":
                // AC: Single Select Enable Connector // #18 KM
                newElement.enableConnector = false; // #18 KM
                newElement.connectorID = ""; // #18 KM
                newElement.connectorKey = ""; // #18 KM
                newElement.connectorTitle = ""; // #18 KM
                ...
                // Connector Enhancement - Ensure Connector List is Updated on New Control // #18 KM
                getConnectorList(); // #18 KM
                break;
        ...
        controller.fillPrePopulated(elementData); // #18 KM
    ...
    pressOutlineItem: function () {
        ...
        // AC: Fill Pre Populated Value Options // #18 KM
        controller.fillPrePopulated(element); // #18 KM

        // AR: update refernce field names // #18 KM
        controller.updateReferenceFieldName(element); // #18 KM
        ...
        // // AC: Single Select Connector // #18 KM
        // if (element.type === "SingleSelect") { // #18 KM
        //     fillConnectorInfo(element.connectorID, element.connectorKey, element.connectorTitle); // #18 KM
        // } // #18 KM

        // // Conditional Access // #18 KM
        // modeloPageDetail.oData.setup.forEach(function (section) { // #18 KM
        //     section.elements.forEach(function (element) { // #18 KM
        //         addConditionalField(element); // #18 KM
        //         if (element.elements) { // #18 KM
        //             element.elements.forEach(function (element) { // #18 KM
        //                 addConditionalField(element); // #18 KM
        //             }); // #18 KM
        //         } // #18 KM
        //     }); // #18 KM
        ...
        // modellistVisibility.setData(visibilityFields); // #18 KM
