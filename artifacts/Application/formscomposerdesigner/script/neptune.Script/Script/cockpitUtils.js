const cockpitUtils = {
    ...
    unlock: function () {
        ...
        // Check for changes
        if (cockpitUtils.formHasChanged()) {
    ...
    back: function () {
        var processFunction = function () {
            ...
            //Clears the data selections and the support data
            tabData.clearSelection();
            delete modelappControl.getData().itemSingleForm;
            delete modelappControl.getData().projectItemSelected;
            delete modelappData.getData().selectedForm
    ...
    formHasChanged: () => {
        ...
        return (cockpitUtils.dataSaved !== modeloPageDetail.getJSON()) || (cockpitUtils.configSaved !== Utils.getFormConfigJSON());
    }
};
